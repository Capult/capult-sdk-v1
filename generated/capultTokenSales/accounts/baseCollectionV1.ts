...
> {
  return mapSerializer<BaseCollectionV1AccountDataArgs, any, BaseCollectionV1AccountData>(
...
export function deserializeBaseCollectionV1(rawAccount: RpcAccount): BaseCollectionV1 {
  return deserializeAccount(rawAccount, getBaseCollectionV1AccountDataSerializer());
}
...
export async function safeFetchAllBaseCollectionV1(
  ...
  return maybeAccounts
    ...
    .map((maybeAccount) => deserializeBaseCollectionV1(maybeAccount as RpcAccount));
}

export function getBaseCollectionV1GpaBuilder(context: Pick<Context, 'rpc' | 'programs'>) {
  ...
  return gpaBuilder(context, programId)
    ...
    .deserializeUsing<BaseCollectionV1>((account) => deserializeBaseCollectionV1(account))
